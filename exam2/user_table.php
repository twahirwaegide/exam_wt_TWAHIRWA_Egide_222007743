...
if ($result->num_rows > 0) {
    ...
    echo "<tr>";
    echo "<th style='padding: 8px;'>user name</th>";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td style='padding: 8px;'>" . $row['first name'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['last name'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['role'] . "</td>";
        // Action buttons
