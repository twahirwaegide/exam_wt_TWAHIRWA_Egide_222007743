...
if ($result->num_rows > 0) {
    ...
    echo "<h2><center>attendee table</center></h2>";
    echo "<table border='1' style='width: 100%; border-collapse: collapse;'>";
    echo "<thead style='background-color: #f2f2f2;'>";
    echo "<tr>";
    echo "<th style='padding: 8px;'>attendee id</th>";
    echo "<th style='padding: 8px;'>user id</th>";
    echo "<th style='padding: 8px;'>workshop id</th>";
    echo "<th style='padding: 8px;'>feedback</th>";
    echo "<th style='padding: 8px;'>attendee status</th>";
    echo "</tr>";
    echo "</thead>";
    echo "<tbody>";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>";
        echo "<td style='padding: 8px;'>" . $row['attendee id'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['user id'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['workshop id'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['feedback'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['attendee status'] . "</td>";
        // Action buttons
