...
if ($result->num_rows > 0) {
    ...
    echo "<h2><center>instructor table</center></h2>";
    echo "<table border='1' style='width: 100%; border-collapse: collapse;'>";
    echo "<thead style='background-color: #f2f2f2;'>";
    echo "<tr>";
    echo "<th style='padding: 8px;'>instructor id</th>";
    echo "<th style='padding: 8px;'>user id</th>";
    echo "<th style='padding: 8px;'>expertise</th>";
    echo "<th style='padding: 8px;'>bio</th>";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>";
        echo "<td style='padding: 8px;'>" . $row['instructor id'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['user id'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['expertise'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['bio'] . "</td>";
