...
$query = "SELECT * FROM personal_finance_resources";
...
if ($result->num_rows > 0) {
    ...
    echo "<h2><center>personal_finance_resources table</center></h2>";
    echo "<table border='1' style='width: 100%; border-collapse: collapse;'>";
    echo "<thead style='background-color: #f2f2f2;'>";
    echo "<tr>";
    echo "<th style='padding: 8px;'>resource_id</th>";
