...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>";
        echo "<td style='padding: 8px;'>" . $row['payment_id'] . "</td>";
        ...
        echo "<td style='padding: 8px;'>" . $row['payment date'] . "</td>";
        echo "<td style='padding: 8px;'>" . $row['payment status'] . "</td>";
        // Action buttons
